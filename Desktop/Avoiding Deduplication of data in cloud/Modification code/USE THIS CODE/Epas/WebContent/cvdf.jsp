...
PreparedStatement ps=con.prepareStatement("select * from image where oname=?&&status='"+status+"' ");
...
<body>
	...
	<div id="body">
		<div class="content">
			...
			<%=msg %>
			<%} %>
			<h3>View Deduplicate Images</h3></center>
			<h2>&nbsp;</h2>
			<center><table>
			<tr>
			<th>Owner Name</th>
			...
			<td><a href="accept3.jsp?a=<%=rs.getString(2)%>&&r=<%=rs.getString(3)%>"><font color="green">Accept</font></a><br>
