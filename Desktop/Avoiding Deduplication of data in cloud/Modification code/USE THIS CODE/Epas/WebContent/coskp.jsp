...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from img where oname=? and status='Not Accepted'");
...
<body>
	...
	<div id="body">
		<div class="content">
			<h2>&nbsp;</h2>
			<center><h3>View User Request for Images</h3></center>
			<h2>&nbsp;</h2>
			<center>
			<table>
			<tr>
			...
			<td><a href="accept11.jsp?a=<%=rs.getString(1)%>&&r=<%=rs.getString(7)%>"><font color="green">Accept</font></a><br>
			<a href="reject11.jsp?a=<%=rs.getString(1)%>&&r=<%=rs.getString(7)%>"><font color="green">Reject</font></a></td>
			</tr>
			<%}
			}
			catch(Exception e)
