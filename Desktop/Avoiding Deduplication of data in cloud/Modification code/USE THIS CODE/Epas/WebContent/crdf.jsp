...
PreparedStatement ps=con.prepareStatement("select * from image where request='"+req+"' ");
...
<body>
	...
	<div id="body">
		<div class="content">
			<h2>&nbsp;</h2>
			<center><h3>Delete Duplicate Images</h3>
			<h2>&nbsp;</h2>
			<center><table>
			<tr>
			<th>Owner Name</th>
			...
			<td><a href="del1.jsp?d=<%=rs.getString(3) %>">Delete</a></td>
			</tr><%}
			}
			catch(Exception e)
			{
