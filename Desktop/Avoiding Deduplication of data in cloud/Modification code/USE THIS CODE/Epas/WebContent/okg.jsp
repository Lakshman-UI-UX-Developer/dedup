...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from fkey where oname=?&&status='"+status+"'&&gkey='"+gkey+"'");
...
<body>
	...
	<div id="body">
		<div class="content">
			<h2>&nbsp;</h2>
			<center><h3>Generate Key</h3></center>
			<h2>&nbsp;</h2>
			<center>
			<table>
			<tr>
			...
			<td><a href="okg1.jsp?a=<%=rs.getString(1)%>&&r=<%=rs.getString(7)%>"><font color="green">generate Key</font></a></td>
			</tr>
			<%}
			}
			catch(Exception e)
