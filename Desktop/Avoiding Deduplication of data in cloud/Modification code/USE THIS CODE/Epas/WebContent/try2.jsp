...
<body>
	<div id="header">
		...
		<ul>
			...
			<li><a href="ouf.jsp">Upload Files</a></li>
	...
	<div id="body">
		<div class="content">
			...
			<h2>&nbsp;</h2>
			<form action="upload3.jsp" method="post" name="reg"
				onsubmit="return val()">
				<label for="fullName"> <span>Id:</span> <input type="text"
					name="fid" id="fullName" value="<%=n%>">
				</label> <label for="emailAdd"> <span>Name:</span> <input
					type="text" name="fname" id="emailAdd">
				</label> <label for="emailAdd"> <span>Date:</span> <input
					type="text" value="<%=strDateNew1%>" name="date" id="emailAdd">
				</label>
