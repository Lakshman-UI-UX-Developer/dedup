...
try
{
	...
	PreparedStatement ps=con.prepareStatement("select * from img where uname=?&&status='"+status+"'");
	ps.setString(1,name);
	...
	<div id="body">
		<div class="content">
			...
			<%while(rs.next())
			{
				...
				<td><a href="down2.jsp?k=<%=rs.getString(4)%>&&fname=<%=rs.getString(3)%>">Download File</a></td>
				</tr>
			<%} %>
